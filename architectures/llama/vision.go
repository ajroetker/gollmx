...
// NumImageTokens returns the number of image tokens for LLaVA.
// LLaVA uses all patches directly (no pooling): (imageSize/patchSize)^2.
...
// LLaVA uses a 2-layer MLP projector: Linear → GELU → Linear.
